...
$( "#pwa_state" ).keypress(function(e) {
  ...
  $('#pwa_resetpassword').click(function() {
    var spassword = $('#pwa_password_reset').val().length;
    if(spassword < 8) {
      $('#notvalid_reset_password').html('| Min 8 character!');
      $('#pwa_password_reset').focus();
      return false;
    } else {
      $('#notvalid_reset_password').html('');
    }
    var scpassword = $('#pwa_cpassword_reset').val().length;
    if(scpassword < 8) {
      $('#notvalid_reset_password_c').html('| Min 8 character!');
      $('#pwa_cpassword_reset').focus();
      return false;
    } else {
      $('#notvalid_reset_password_c').html('');
    }
    var pw1 = $('#pwa_password_reset').val();  
    var pw2 = $('#pwa_cpassword_reset').val();  
    if(pw1 != pw2) {   
      $('#notvalid_reset_password_c').html('| Password do not match!');
      $('#pwa_cpassword_reset').focus();
      return false;  
    }
  });
  ...
  $('#pwa_updatebtnsign').click(function() {
      var password = document.getElementById("pwa_password").value;
      var cnfrmpassword = document.getElementById("pwa_cpassword").value;
        if(password=="" && cnfrmpassword==""){
        var currentpassword = document.getElementById("pwa_old_passwordvalue").value;
        document.getElementById("pwa_password").value = currentpassword;
        document.getElementById("pwa_cpassword").value = currentpassword;
    }
    var sign_name = $('#pwa_name').val().length;
    if(sign_name < 2) {
